...
namespace BigMountainX
{
    ...
    public sealed partial class ApplicationHostPage : Page
    {
        ...
        {
            root_frame.Navigate(typeof(TicketingPage));
        }
        ...
        private void OnManageEventsClicked(object sender, RoutedEventArgs e)
        {
            root_frame.Navigate(typeof(EmployeeSignIn), typeof(ManageEventsPage));
        }

        private void OnGetTicketsClicked(object sender, RoutedEventArgs e)
        {
            root_frame.Navigate(typeof(TicketingPage));
        }

        private void OnManageMailingListClicked(object sender, RoutedEventArgs e)
        {
            root_frame.Navigate(typeof(EmployeeSignIn), typeof(ManageMailingList));
        }
    }
}
